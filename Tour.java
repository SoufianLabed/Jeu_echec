...
public class Tour extends Piece {
	public Tour(int couleur, int i,int j){
	    super("Tour",couleur,i,j,3);
	  }

	/* cette fonction va nous dire si le mouvement est valide ,
	   la tour se deplace horizontalement ou verticalement. Donc il faut que le
	   deplacement horizontal soit nul, ou bien que le deplacement vertical soit nul.
	 */

	public boolean mouvement_possible(int horizontal, int vertical){
		return Math.abs(horizontal)* Math.abs(vertical) == 0;
	}
	...
	//La fonction qui va nous permettre de deplacer notre Tour.
